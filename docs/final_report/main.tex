...
% \usepackage[UTF8]{ctex}  % 自动加载xeCJK或LuaLaTeX下的支持
\usepackage{multirow}
\usepackage{bbm}
\newcommand{\xmark}{$\mathbbm{x}$}
...
\author{Chen Yuan (3036383185) \\ Xu Hanlin (3036410665) \\ Yu Yitao (3036380846) \\ Su Yingcheng (3036408856)}
\date{July 18, 2025}
